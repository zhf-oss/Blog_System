...
public class MessageAdminController {
    ...
    public String messageList(@RequestParam(value = "page",required = false)String page, @RequestParam(value = "limit",required = false)String limit, HttpServletResponse response)throws Exception{
    ...
    public String update(@RequestParam(value = "id")String id,HttpServletResponse response)throws Exception{
        messageService.update(Integer.parseInt(id));
        JSONObject result = new JSONObject();
        result.put("success",true);
        ResponseUtil.write(response,result);
        return null;
