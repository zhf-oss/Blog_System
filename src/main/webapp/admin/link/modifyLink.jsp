    ...
    <table cellspacing="20px">
        ...
        <tr>
            <div class="layui-form-item" style="margin-top: 20px;">
                ...
                <div class="layui-input-block">
                    <button onclick="submitData()" id="button" type="button" class="layui-btn layui-btn-sm layui-btn-normal">修改友情链接</button>
                </div>
            </div>
        </tr>
    </table>
...
<script type="text/javascript">
    ...
    function childLinkData(data) {
        linkData = data;
        // 回显博客的值，String()转字符串
        $("#linkName").val(String(linkData.linkName));
        $("#linkUrl").val(String(linkData.linkUrl));
        $("#orderNo").val(String(linkData.orderNo));
    }
    ...
    function submitData() {
        ...
        if(linkName==null || linkName==''){
            ...
            $.post("${pageContext.request.contextPath}/admin/link/save.do",{'id':modifyLink,'linkName':linkName,'linkUrl':linkUrl,'orderNo':orderNo},
                function (result) {
                    if(result.success){
                        alert("修改成功！");
                        // 从父窗口打开的弹出窗
